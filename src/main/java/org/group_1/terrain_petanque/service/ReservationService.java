...
public class ReservationService {
     ...
     */
    @Modifying
    public void updateReservation(int userId, int courtId, ReservationDTO reservationDTO) throws NotFoundException {
        ...
        ReservationMapper.INSTANCE.update(reservation, reservationDTO);
     ...
     * @throws NotFoundException If the reservation are not in the database.
     */
    public ReservationDTO getReservation(int userId, int courtId) throws NotFoundException {
        ReservationKey reservationKey = new ReservationKey(userId, courtId);
        Optional<Reservation> reservationOptional = reservationRepository.findById(reservationKey);
    ...
    public List<ReservationDTO> getAllReservations() {
        ...
        for (Reservation reservation : reservations) {
            result.add(ReservationMapper.INSTANCE.toDTO(reservation));
        }
