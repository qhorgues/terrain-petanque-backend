...
public class CoordinatesController {
    ...
    @PostMapping
    public ResponseEntity<CoordinatesDTO> createCoordinates(@RequestBody CoordinatesDTO coordinates) {
        return ResponseEntity.ok(coordinatesService.addCoordinates(coordinates));
    }
    @PutMapping("/{id}")
    public ResponseEntity<CoordinatesDTO> updateCoordinates(@PathVariable int id,
